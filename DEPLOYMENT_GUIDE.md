...
# IITGEEPREP: Production Deployment Protocol v5.6.0
...
4. Click **"Download Build"** to get the `iitgeeprep-production-mvc-v5.6.0.zip`.
...
3. Import the **`api/sql/master_schema_v5.6.0.sql`** file. This will create 40+ required relational tables with telemetry support.
